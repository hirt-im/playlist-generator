...
export default function Directions(props){
    return(
        <Stack className='intro-container'>
            ...
            <Text className='directions' fontSize={18} pb={2} width='375px' align='center' color='white'>
                ...
                Create a Spotify playlist with ease.
                

                <OrderedList ml={20} align='left' className='list'>
